...
public class PageInterceptor implements Interceptor{
	...
	private BoundSql createNewBoundSql(MappedStatement mappedStatement,BoundSql oldBoundSql,String sql)
	{
		BoundSql newBoundSql = new BoundSql(mappedStatement.getConfiguration(), sql, oldBoundSql.getParameterMappings(), oldBoundSql.getParameterObject());
